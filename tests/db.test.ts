...
describe('openDb', () => {
  it('creates all tables', () => {
    ...
    expect(names).toEqual([
      ...
      'rating_history', 'relay_messages', 'report_message', 'reporter_chat_pings', 'reports', 'round_metric_context', 'round_metrics', 'seasons', 'servers', 'settings', 'signon_drops', 'steam_signal_alerts',
