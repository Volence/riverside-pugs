...
export const SETTINGS_SCHEMA: SettingDef[] = [
  ...
  { key: 'discord_tickets_channel_id', group: 'Discord', label: 'Tickets text channel id', help: 'The text channel that holds the Report a player button\'s private chats between a reporter and the moderators. Staff discussion never happens here: normal tickets use the forum, and Safety concern tickets are worked on the site only.', type: { kind: 'string', maxLength: 32, allowEmpty: true } },
