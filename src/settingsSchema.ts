...
export const SETTINGS_SCHEMA: SettingDef[] = [
  ...
  { key: 'discord_tickets_channel_id', group: 'Discord', label: 'Tickets text channel id', help: 'Holds the private chats between a reporter and the moderators. Staff discussion never happens here: a normal ticket is worked in the tickets forum, and a Safety concern ticket is worked on the site only. Set it to a text channel everyone can see and nobody can post in. Empty: reporters cannot open a chat.', type: { kind: 'string', maxLength: 32, allowEmpty: true } },
