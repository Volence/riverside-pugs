...
export const SETTINGS_SCHEMA: SettingDef[] = [
  ...
  { key: 'ticket_mod_ban_max_minutes', group: 'Penalties', label: 'Longest ban a moderator can issue (minutes)', help: 'Moderators can ban from a ticket up to this long. Anything longer, or permanent, needs an admin. 10080 is seven days. Also caps how long a moderator can time out a Discord-only person from a ticket; Discord\'s own limit there is 28 days (40320 minutes) regardless of this setting.', type: { kind: 'int', min: 1, max: 525600 } },
  ...
  { key: 'discord_tickets_channel_id', group: 'Discord', label: 'Tickets text channel id', help: 'Not used yet. Restricted (Safety concern) tickets are worked on the site only and get no thread here. Private threads made here before this change are kept up. It will hold the reporters\' private chats with the moderators in a later update. Set it to a text channel everyone can see and nobody can post in. Empty: nothing happens.', type: { kind: 'string', maxLength: 32, allowEmpty: true } },
