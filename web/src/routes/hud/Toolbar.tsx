/**
 * The one toolbar above the canvas, in two rows: the HUD (preset, font,
 * aspect, with history, Share and Download on the right), then the Preview
 * (side, card state, what is held, the toggles, backdrop), which never
